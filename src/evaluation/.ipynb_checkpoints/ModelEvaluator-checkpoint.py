...
class ModelEvaluator:
    ...
    def root_mean_squared_error(y_true, y_pred):
        ...
        :param y_true: The actual known values.
        :param y_pred: The predicted values produced by the model.
    ...
    def get_key_metrics(actual_values: pd.Series, predicted_values: pd.Series) -> Dict:
        ...
        rmse = ModelEvaluator.root_mean_squared_error(actual_values, predicted_values)
