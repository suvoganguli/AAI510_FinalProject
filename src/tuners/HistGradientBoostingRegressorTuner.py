...
class HistGradientBoostingRegressorTuner:
    ...
    def tune(x_train: pd.DataFrame, y_train: pd.Series, x_val: pd.DataFrame, y_val: pd.Series) -> Callable:
        """
        This function is used to tune the hyperparameters of the Histogram-based Gradient Boosting Regressor Model.
        ...
        def objective(trial):
            ...
            tune_model = HistGradientBoostingRegressor(random_state=1)
